...
<body>
    ...
    <section class="trupi">
        <div class="image-gallery">
            <div class="item">
                <img src="image/hotel1.jpeg" alt="Image 1" class="gallery-image" onmouseover="expandImage(this)" onclick="hideImage()">
                </div>
                <div class="item">
                <img src="image/hotel2.jpeg" alt="Image 2" class="gallery-image" onmouseover="expandImage(this)" onclick="hideImage()">
                </div>
                <div class="item">
                <img src="image/hotel3.jpeg" alt="Image 3" class="gallery-image" onmouseover="expandImage(this)" onclick="hideImage()">
                </div>
                <div class="item">
                <img src="image/hotel4.jpeg" alt="Image 4" class="gallery-image" onmouseover="expandImage(this)" onclick="hideImage()">   
                </div>
        </div>
